        ...
        k.on(ace.click_event, function(b, c) {
            ...
            (this.pick = function(c, d) {
                if ("number" == typeof c) {
                    ...
                    if (
                        ((c = j.indexOf(e)), -1 == c && d === !0 && (j.push(e), a("<option />").appendTo(f).val(e), a('<li><a class="colorpick-btn"></a></li>').appendTo(k).find("a").css("background-color", e).data("color", e), (c = j.length - 1)), -1 == c)
                    )
                        return;
...
(function(a, b) {
    ...
    (g.prototype.apply_settings = function() {
        ...
        this.well_style ? (this.settings.thumbnail || (this.settings.thumbnail = "small"), this.$element.parent().addClass("ace-file-multiple")) : this.$element.parent().removeClass("ace-file-multiple"),
            ...
            this.$element.after(
                ...
                '"><span class="ace-file-name icon-center1" data-title="' +
                this.settings.no_file +
                '">' +
                (this.settings.no_icon ? '<i class="' + this.settings.no_icon + ' mx-2"></i>' : "") +
                "</span></span>"
            ),
    ...
    (g.prototype.reset_input_ui = function() {
        this.$label
            ...
            .attr({ "data-title": this.settings.no_file, class: "ace-file-name icon-center1" })
            .find(ace.vars[".icon"])
        ...
        l = function(a, b) {
            ...
            return -1 === c ?
                ...
                ((c instanceof Array || (d && c instanceof FileList)) && (a = c),
                    (c = !0),
                    this.settings.before_change && (c = this.settings.before_change.call(this.element, a, b)), -1 === c ? (this.reset_input(), !1) : c && 0 != c.length ? ((c instanceof Array || (d && c instanceof FileList)) && (a = c), a) : (this.$element.data("ace_input_files") || this.reset_input(), !1)) :
    ...
    b.prototype = {
        ...
        sorter: function(a) {
            for (var b, c = [], d = [], e = [];
                (b = a.shift());) b.toLowerCase().indexOf(this.query.toLowerCase()) ? (~b.indexOf(this.query) ? d.push(b) : e.push(b)) : c.push(b);
            return c.concat(d, e);
        },
...
(function(a, b) {
    function c(b, c) {
        ...
        if (
            ((this.settings = a.extend({}, a.fn.ace_aside.defaults, c, j)), !this.settings.background || c.scroll_style || j.scroll_style || (this.settings.scroll_style = "scroll-white no-track"),
        ...
        (this.initiate = function() {
            ...
            g && (g = a.trim(g.toLowerCase())),
                ...
                f.on("mousewheel.aside DOMMouseScroll.aside touchmove.aside pointermove.aside", function(b) {
