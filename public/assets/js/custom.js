$(function () {
    ...
    if (
        document
            .querySelector(".default-menu")
            .classList.contains("error-page1") !== true
    ) {
        hovermenu();
    }
    ...
    if (
        document
            .querySelector(".horizontal-hover")
            .classList.contains("error-page1") !== true
    ) {
        document.querySelector(".horizontal .side-menu").style.flexWrap =
            "nowrap";
...
function removeForTransparent() {
    ...
    if (
        document.querySelector("body").classList.contains("transparent-theme")
    ) {
