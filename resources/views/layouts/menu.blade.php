...
<ul class="side-menu">
    ...
    <li class="slide {{ nav_checkactive(['new-event'], $args, 'is-expanded') }}">
        ...
        <ul class="slide-menu ">
            ...
            <li><a class="slide-item {{ nav_checkactive(['example-index'], $args) }}"
                    href="{{ url_builder('admin.controller', ['example', 'index']) }}">All News & Events</a>
            </li>
            <li class="side-menu__label1 "><a href="javascript:void(0);"></a></li>
            {{-- <li><a class="slide-item active" href="index.html">Dashboard-1</a></li> --}}
    ...
    <li class="slide {{ nav_checkactive(['example'], $args, 'is-expanded') }}">
        ...
        <ul class="slide-menu ">
            ...
            {{-- <li><a class="slide-item active" href="index.html">Dashboard-1</a></li> --}}
            <li><a class="slide-item {{ nav_checkactive(['example-index'], $args) }}"
                    href="{{ url_builder('admin.controller', ['example', 'index']) }}">All Equipments</a>
            </li>
            <li class="side-menu__label1 "><a href="javascript:void(0);"></a></li>
            {{-- <li><a class="slide-item active" href="index.html">Dashboard-1</a></li> --}}
            <li><a class="slide-item {{ nav_checkactive(['example-create'], $args) }}"
    ...
    <li class="slide {{ nav_checkactive(['example'], $args, 'is-expanded') }}">
        ...
        <ul class="slide-menu ">
            ...
            {{-- <li><a class="slide-item active" href="index.html">Dashboard-1</a></li> --}}
            <li><a class="slide-item {{ nav_checkactive(['example-index'], $args) }}"
                    href="{{ url_builder('admin.controller', ['example', 'index']) }}">All Inventorys</a>
            </li>
            <li class="side-menu__label1 "><a href="javascript:void(0);"></a></li>
            {{-- <li><a class="slide-item active" href="index.html">Dashboard-1</a></li> --}}
            <li><a class="slide-item {{ nav_checkactive(['example-create'], $args) }}"
    ...
    <li class="slide {{ nav_checkactive(['vendors'], $args, 'is-expanded') }}">
        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><i
        ...
        <ul class="slide-menu ">
            <li class="side-menu__label1 "><a href="javascript:void(0);"></a></li>
            {{-- <li><a class="slide-item active" href="index.html">Dashboard-1</a></li> --}}
            <li><a class="slide-item {{ nav_checkactive(['vendors-index'], $args) }}"
                    href="{{ url_builder('admin.controller', ['media']) }}">All Vendors</a>
            </li>
            <li class="side-menu__label1 "><a href="javascript:void(0);"></a></li>
            {{-- <li><a class="slide-item active" href="index.html">Dashboard-1</a></li> --}}
            <li><a class="slide-item {{ nav_checkactive(['vendors-create'], $args) }}"
    ...
    <li class="slide {{ nav_checkactive(['switcher'], $args, 'is-expanded') }}">
        ...
        <ul class="slide-menu ">
            ...
            {{-- <li><a class="slide-item active" href="index.html">Dashboard-1</a></li> --}}
            <li><a class="slide-item {{ nav_checkactive(['media-index'], $args) }}"
                    href="{{ url_builder('admin.controller', ['media']) }}">Media</a>
            </li>
        ...
        <ul class="slide-menu">
            ...
            <li class="sub-slide">
                ...
                <ul class="sub-slide-menu">
                    ...
                    <li><a class="sub-side-menu__item" href="underconstruction.html">UnderConstruction</a>
                    </li>
            ...
            <li class="sub-slide">
                ...
                <ul class="sub-slide-menu">
                    ...
                    <li><a class="sub-side-menu__item" href="switcher-1.html">Switcher-1</a>
                    </li>
                </ul>
            </li>
            <li class="sub-slide">
                <a class="slide-item" data-bs-toggle="sub-slide" href="javascript:void(0);"><span
                        class="sub-side-menu__label">Ecommerce</span><i class="sub-angle fe fe-chevron-right"></i></a>
                <ul class="sub-slide-menu">
                    <li><a class="sub-side-menu__item" href="shop.html">Shop</a></li>
                    <li><a class="sub-side-menu__item" href="product-details.html">Product-Details</a>
                    </li>
            ...
            <li><a class="slide-item" href="profile-notifications.html">Notifications-list</a>
            </li>
            <li><a class="slide-item" href="aboutus.html">About us</a></li>
            <li><a class="slide-item" href="settings.html">Settings</a></li>
            <li class="sub-slide">
                <a class="slide-item" data-bs-toggle="sub-slide" href="javascript:void(0);"><span
                        class="sub-side-menu__label">Mail</span><i class="sub-angle fe fe-chevron-right"></i></a>
                <ul class="sub-slide-menu">
        ...
        <ul class="slide-menu">
            ...
            <li class="sub-slide">
                ...
                <ul class="sub-slide-menu">
                    ...
                    <li class="sub-slide2">
                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="javascript:void(0);"><span
    ...
    <li class="slide">
        ...
        <ul class="slide-menu">
            ...
            <li><a class="slide-item" href="form-input-spinners.html">Form Input Spinners</a>
            </li>
        </ul>
    </li>
    <li class="slide">
