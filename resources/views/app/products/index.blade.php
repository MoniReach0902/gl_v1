                    ...
                    <table class="table table-bordered table-hover mb-0 text-md-nowrap">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th style="width: 10px">Decription</th>
                                <th style="width: 10px">Cost</th>
                                <th style="width: 10px">Price</th>
                                <th style="width: 10px">ColorID</th>
                                <th style="width: 10px">TypeID</th>
                                <th style="width: 10px">Categories ID</th>
                                <th style="width: 10px">PrandID</th>
