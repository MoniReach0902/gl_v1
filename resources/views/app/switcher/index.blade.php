                                                ...
                                                <div class="switch_section">
                                                    <div class="switch-toggle d-flex mt-2">
                                                        ...
                                                        <p class="onoffswitch2 my-0">
                                                            <input type="radio" name="onoffswitch25" id="myonoffswitch54"
                                                    ...
                                                    <div class="switch-toggle d-flex mt-2">
                                                        ...
                                                        <div class="">
                                                            <input
                                                                ...
                                                                value="#38cab3" id="darkPrimaryColorID"
                                                                oninput="darkPrimaryColor()" type="color"
                                            ...
                                            <div class="skin-body">
                                                <div class="switch_section">
                                                    <div class="switch-toggle d-flex mt-2">
                                                        ...
                                                        <p class="onoffswitch2 my-0"><input type="radio"
                                                                name="onoffswitch1" id="myonoffswitchTransparent"
                                                                class="onoffswitch2-checkbox">
                                                    ...
                                                    <div class="switch-toggle d-flex">
                                                        ...
                                                        <div class="">
                                                            <input
                                                                ...
                                                                value="#38cab3" id="transparentPrimaryColorID"
                                                                oninput="transparentPrimaryColor()" type="color"
                                                                data-id="bg-color" data-id1="bg-hover"
                                                                data-id2="bg-border" data-id3="primary"
                                                    ...
                                                    <div class="switch-toggle d-flex mt-2">
                                                        ...
                                                        <div class="">
                                                            <input
                                                                ...
                                                                value="#38cab3" id="transparentBgColorID"
                                                ...
                                                <div class="switch_section">
                                                    <div class="switch-toggle d-flex">
                                                        ...
                                                        <div class="">
                                                            <input
                                                                class="wd-30 ht-30 input-transparent-color-picker color-primary-transparent"
                                                                value="#38cab3" id="transparentBgImgPrimaryColorID"
                                                    ...
                                                    <div class="switch-toggle">
                                                        <a class="bg-img1" onclick="bgImage(this)"
                                                            href="javascript:void(0);"><img
                                                                src="../assets/img/media/bg-img1.jpg" id="bgimage1"
                                                                alt="switch-img" class="br-5 me-2 mb-2"></a>
                                                        <a class="bg-img2" onclick="bgImage(this)"
                                                            href="javascript:void(0);"><img
                                                                src="../assets/img/media/bg-img2.jpg" id="bgimage2"
                                                                alt="switch-img" class="br-5 me-2 mb-2"></a>
                                                        <a class="bg-img3" onclick="bgImage(this)"
                                                            href="javascript:void(0);"><img
                                                                src="../assets/img/media/bg-img3.jpg" id="bgimage3"
                                                                alt="switch-img" class="br-5 me-2 mb-2"></a>
                                                        <a class="bg-img4" onclick="bgImage(this)"
                                                            href="javascript:void(0);"><img
                                                                src="../assets/img/media/bg-img4.jpg" id="bgimage4"
                                                                alt="switch-img" class="br-5 me-2 mb-2"></a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="skin-body">
                                                <div class="switch_section">
                                                    <div class="switch-toggle d-flex">
                                                        ...
                                                        <p class="onoffswitch2 my-0">
                                                            <input type="radio" name="onoffswitch2" id="myonoffswitch3"
                                                                class="onoffswitch2-checkbox" checked>
