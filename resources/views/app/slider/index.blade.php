    ...
    <script>
        $(document).ready(function() {
            ...
            $("#btnnew_{{ $obj_info['name'] }}").click(function(e) {
                ...
                // let loading_indicator = '';
                // helper.silentHandler(route_import, null, extraFrm, setting, popModal, 'air_windows',
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-4 text-right">
                    ...
                    <button type="button" class="btn btn-outline-success btn-sm btn-flat dropdown-toggle ct-btn-action"
                        data-toggle="dropdown" aria-expanded="false" id="save_img">

                        <i class="fas fa-file-export"></i><br>@lang('dev.save')
