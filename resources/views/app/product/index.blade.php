                    ...
                    <div class="col-lg-8 col-xl-2">
                        <div class="card">
                            <div class="main-content-left main-content-left-mail card-body">
                                <a class="btn btn-primary btn-compose" id="btnCompose" data-bs-target="#Vertically"
                                    data-bs-toggle="modal" href=""><i class="fa fa-plus me-2"></i> Add Categorie</a>
                                <div class="main-mail-menu">
                                    <nav class="nav main-nav-column">
                                        <a class="nav-link thumb" href="javascript:void(0);">categorie name1<span
                                                class="badge rounded-pill bg-warning number-badge"><b>11</b></span> </a>
                                        <a class="nav-link thumb" href="javascript:void(0);">categorie name2<span
                                                class="badge rounded-pill bg-warning number-badge"><b>40</b></span></a>
                                        <a class="nav-link thumb" href="javascript:void(0);">categorie name3<span
                                                class="badge rounded-pill bg-warning number-badge"><b>20</b></span> </a>
                                        <a class="nav-link thumb" href="javascript:void(0);">categorie name4<span
                                                class="badge rounded-pill bg-warning number-badge"><b>50</b></span></a>
                                        <a class="nav-link thumb" href="javascript:void(0);">categorie name5<span
                                                class="badge rounded-pill bg-warning number-badge"><b>60</b></span> </a>
                                        <a class="nav-link thumb" href="javascript:void(0);">categorie name6<span
                                                class="badge rounded-pill bg-warning number-badge"><b>88</b></span></a>
                                    </nav>
                                </div><!-- main-mail-menu -->
                            </div>
                        </div>
                                    ...
                                    <a href="file-manager1.html">
                                        <div class="card-body">
                                            <div class="tx-16 mb-1">
                                                <svg class="file-manager-icon me-2" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <tbody>
                                        @foreach ($results as $products)
                                            <tr>
                                                ...
                                                <td><img src="https://post.medicalnewstoday.com/wp-content/uploads/sites/3/2020/02/322868_1100-800x825.jpg"
                                                        width="80"></td>
                                                <td>{{ $products['text'] }}</td>
