...
{
    //
    private $obj_info = ['name' => 'color', 'routing' => 'admin.controller', 'title' => 'color', 'icon' => '<i class="fa fa-tags"></i>'];
    public $args;
    ...
    public function sfp($request, $results)
    {
        ...
        $appends = [];
        $querystr = [];
        if ($request->has('txtsearch') && !empty($request->input('txtsearch'))) {
            $qry = $request->input('txtsearch');
