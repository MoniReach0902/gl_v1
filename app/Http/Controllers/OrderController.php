...
{
    //
    private $obj_info = ['name' => 'order', 'routing' => 'admin.controller', 'title' => 'Order', 'icon' => '<i class="fa fa-shopping-cart"></i>'];
    public $args;
